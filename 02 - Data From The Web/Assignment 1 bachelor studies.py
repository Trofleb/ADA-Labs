...
# Our null hypothethis H0 is that the difference between the two means is the same (no difference). Using "Two-Sample T-Test" based on our two sample population, we select our alpha to be 0.05 in order to be sure at 95% with no assumption concerning the variance.
